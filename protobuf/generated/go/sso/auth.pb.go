...
var file_sso_auth_proto_rawDesc = []byte{
	...
	0x32, 0x7d, 0x0a, 0x0a, 0x53, 0x53, 0x4f, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x3b,
	...
	0x2f, 0x5a, 0x2d, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x44, 0x4b,
...
var file_sso_auth_proto_depIdxs = []int32{
	0, // 0: auth.SSOService.Register:input_type -> auth.RegisterRequest
	2, // 1: auth.SSOService.Login:input_type -> auth.LoginRequest
	1, // 2: auth.SSOService.Register:output_type -> auth.RegisterResponse
	3, // 3: auth.SSOService.Login:output_type -> auth.LoginResponse
